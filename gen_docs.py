...
INCLUDED_OBJECTS = [
    "park_it.app.build_app.build_app",
    "park_it.models.app_config.AppConfig",
    "park_it.models.space.SpaceConfig",
    "park_it.models.field_types.ImageFile",
]
# whole files to include pages for in the code reference
INCLUDED_PY_FILES = [SRC_ROOT / "park_it" / "models" / "space_update.py"]
